...
const useViewModel = () => {
  ...
  const recordCustomMetrics = async () => {
    ...
    newRelic.recordMetric(
      'RNCustomMetricName',
      'RNCustomMetricCategory',
      13,
      newRelic.MetricUnit.PERCENT,
      newRelic.MetricUnit.SECONDS,
    );
  };
  ...
  return {
    onRecordBreadCrumbsClick,
    startInteraction,
    stopInteraction,
    recordCustomMetrics,
    recordCustomErrors,
    tractHTTPRequest,
    trackFailingHTTPTransactions,
    shutDownAgent,
    testCrash,
    recordCustomAttribute,
    recordIncrementSessionAttribute,
    recordCustomEvents,
    getSessionId,
    styles,
    t,
